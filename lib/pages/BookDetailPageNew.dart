...
class BookDetailPageNew extends StatefulWidget {
  final String id;
  final String name;

  const BookDetailPageNew({Key key, this.id, this.name}) : super(key: key);
...
class _BookDetailPageState extends State<BookDetailPageNew> {
  String id = '';
